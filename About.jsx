      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <motion.div
            ...
            className="lg:col-span-6 glass-panel rounded-2xl p-6 sm:p-8 flex flex-col justify-between border border-slate-800"
          >
            <div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-800">
              ...
              <div className="flex flex-wrap gap-3">
                {languagesData.map((lang, idx) => (
                  <div key={idx} className="px-3.5 py-1.5 rounded-lg bg-slate-900 border border-slate-800 flex items-center gap-2 text-xs">
            ...
            {interestsData.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-panel glass-panel-hover rounded-xl p-5 border border-slate-800 flex items-start gap-4"
                >
                  <div className="p-3 rounded-xl bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 border border-cyan-500/30 text-cyan-400 shrink-0">
        ...
        <div>
          <h3 className="text-xl font-bold text-white mb-8 flex items-center gap-2.5 justify-center">
            ...
            {educationData.map((edu, idx) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-4">{edu.location}</p>
