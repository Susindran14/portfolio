      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {achievementsData.map((ach, idx) => (
          <motion.div
            ...
            className="mb-16 glass-panel rounded-2xl p-6 sm:p-8 border border-amber-500/30 bg-gradient-to-r from-amber-500/10 via-slate-900 to-purple-500/10 relative overflow-hidden group"
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 relative z-10">
              <div className="p-4 rounded-2xl bg-amber-500/20 text-amber-400 border border-amber-500/40 shrink-0 shadow-lg shadow-amber-500/10">
        ...
        <div>
          <h3 className="text-xl font-bold text-white mb-8 flex items-center gap-2.5 justify-center">
            <BookCheck className="w-6 h-6 text-cyan-400" />
